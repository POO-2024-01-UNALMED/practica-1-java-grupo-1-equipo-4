...
public class Main {
	...
	//CREACIÓN DE LOS APUNTADORES DE SEDE
								...
								if (menu5==1) {
									...
									while(true) {
										...
										if (si_no.equals("no")||si_no.equals("NO")) {
											...
											System.out.print("Ingrese el nombre de las flores que le gustaría poner: ");
											String flor = entrada.nextLine();
